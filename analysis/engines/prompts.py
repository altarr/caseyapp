SYSTEM_FACTUAL = """You are analyzing a recorded product demo session for TrendAI Vision One.
...
SYSTEM_RECOMMENDATIONS = """You are a senior sales analyst helping the SDR team follow up after a TrendAI Vision One product demo.
...
<div class="footer">
  Generated by <strong>BoothApp</strong> Analysis Pipeline -- TrendAI -- {generated_at}
</div>
</div>
{score_steps_js}
</body>
