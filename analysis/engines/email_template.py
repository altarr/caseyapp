...
suitable for sending via any email platform. Uses TrendAI brand styling with
...
def render_follow_up_email(summary, follow_up, metadata=None):
    ...
    if interest_text:
        ...
        intro = (
            "Thank you for taking the time to explore TrendAI Vision One "
  ...
  <tr>
    <td style="background-color:#0f172a;padding:24px 32px;text-align:center">
      <div style="font-size:11px;color:#94a3b8;line-height:1.6;letter-spacing:0.02em">
        This email was generated by TrendAI BoothApp.<br>
        Questions? Reply to this email or contact your account team.<br>
        <span style="color:#475569">TrendAI Incorporated</span>
      </div>
    </td>
  </tr>
